          ...
          {products.map((product, index) => {
            ...
            return (
              <motion.div
                ...
                className="bg-white/10 backdrop-blur-md rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden border border-white/20"
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-2 mb-6">
                    ...
                    <div className="flex justify-between items-center py-2 px-3 bg-white/20 backdrop-blur-md rounded-lg">
